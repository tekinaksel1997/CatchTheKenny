...
//  CatchTheKenny
//
//  Created by Tekin Aksel Demir on 6.09.2022.
//
...
class ViewController: UIViewController {
    ...
    @objc func hideKenny() {
    //kenny1.isHidden = true tek biri için yapılabilir
    ...
    @objc func countDown() {
        ...
        if counter == 0 {
            ...
            if self.score > self.high {
                ...
                highScore.text = "Highscore: \(self.high)"
                UserDefaults.standard.set(self.high, forKey: "high")
            }
